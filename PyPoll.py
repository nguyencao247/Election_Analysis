...
# 1. The number of total votes cast
...
candidate_options= [] 
# declare dictionary of candidates and their vote counts
candidate_votes = {}
...
with open(file_to_save, "w") as txt_file:
    ...
    for candidate_name in candidate_votes:
        ...
        if (votes > winning_count) and (vote_percentage > winning_percentage):
            # 2. If true then set winning_count = votes and winning_percent = voting_percentage.
            winning_count = votes
